// editorial-memory (Deno copy) — miroir 1:1 de
// packages/shared/src/editorial-memory.ts. Deno ne peut pas importer depuis
// packages/, donc on duplique. La copie packages/ fait foi (testée Vitest).
